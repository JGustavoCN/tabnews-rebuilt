  ...
  const [cupons, setCupons] = useState([
    {
      ...
      emoji: "💆‍♀️",
      descricao:
        "30 min focados nas suas costas e ombros. Adeus dor muscular, olá relaxamento.",
      resgatado: false,
    },
    {
      id: 2,
      ...
      emoji: "🛌",
      descricao:
        "Minha presença, meu cheiro e meu abraço a noite toda. Para você se sentir segura.",
      resgatado: false,
    },
    {
      id: 3,
      ...
      emoji: "🔒",
      descricao:
        "Um momento 100% desconectado do mundo. Sem problemas, só eu, você e nosso carinho.",
      resgatado: false,
    },
    {
      id: 4,
      ...
      emoji: "🍝",
      descricao:
        "Eu assumo a cozinha. Você senta, toma um vinho (ou suco) e espera ser servida.",
      resgatado: false,
    },
    {
      id: 5,
      ...
      emoji: "💋",
      descricao:
        "Aquele beijo lento, sem hora para acabar, igual ao do nosso começo.",
      resgatado: false,
    },
    {
      id: 6,
      ...
      emoji: "👂",
      descricao:
        "Sou todo ouvidos. Pode reclamar, chorar ou contar do dia. Eu tô aqui pra você.",
      resgatado: false,
    },
  ]);
  ...
  const resgatarCupom = (id) => {
    const novosCupons = cupons.map((cupom) => {
      if (cupom.id === id && !cupom.resgatado) {
        ativarToast(
          `✨ Cupom "${cupom.titulo}" ativado! Mande o print agora. ❤️`,
        );
      ...
      <main className="content">
        <header className="header">
          ...
          <p className="subtitle">
            Amor ❤️, sei que o cansaço bate forte.
            <br />
        ...
        * {
        ...
        .aurora-background {
          ...
          background:
            radial-gradient(
              at 0% 0%,
              hsla(253, 16%, 7%, 0.05) 0,
              transparent 50%
            ),
            radial-gradient(
              at 50% 0%,
              hsla(225, 39%, 30%, 0.05) 0,
              transparent 50%
            ),
            radial-gradient(
              at 100% 0%,
              hsla(339, 49%, 30%, 0.05) 0,
              transparent 50%
            );
          background:
            radial-gradient(
              at 40% 20%,
              rgba(255, 183, 178, 0.4) 0px,
              transparent 50%
            ),
            radial-gradient(
              at 80% 0%,
              rgba(255, 218, 193, 0.4) 0px,
              transparent 50%
            ),
            radial-gradient(
              at 0% 50%,
              rgba(226, 240, 203, 0.4) 0px,
              transparent 50%
            );
          filter: blur(60px);
